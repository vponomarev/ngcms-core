...
<div>
	...
	<div align="center">
		<button class="btn btn-primary btn-large" type="submit" onclick="return make_vote(1);"><span>Голосовать</span></button>
		<button class="btn btn-primary btn-large" type="button" onclick="return make_vote(0);"><span>Результаты</span></button>
	</div>
</div>
</form>
</div>
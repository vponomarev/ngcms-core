	...
	<div class="pad20_f">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td width="70%"><input type="text" name="to_username" id="to_username" tabindex="3" autocomplete="off" value="{{ username }}" /><span id="suggestLoader" style="width: 20px; visibility: hidden;"><img src="{{skins_url}}/images/loading.gif"/></span></td>
			</tr>
			<tr>
				<td colspan="2">
					...
					<div>
						<label>{{ lang['pm:saveoutbox'] }}&nbsp;&nbsp;<input name="saveoutbox" type="checkbox"/></label>
					</div>
				</td>
			</tr>
			<tr>

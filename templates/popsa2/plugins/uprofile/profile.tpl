	...
	<div class="telo">
		<table class="table">
			...
			<tr>
				...
				<td class="input"><input type="password" name="editpassword" autocomplete="off" /><br /><small>{l_uprofile:pass_left}</small></td>
			</tr>
			<tr>
				<td>{{ lang.uprofile['oldpass'] }}:</td>
				<td class="input"><input type="password" name="oldpass" value=""autocomplete="off" /><br/><small>{{ lang.uprofile['oldpass#desc'] }}</small></td>
			</tr>

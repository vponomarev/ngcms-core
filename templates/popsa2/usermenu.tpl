...
{% if pluginIsActive('auth_loginza') %}<script src="http://loginza.ru/js/widget.js" type="text/javascript"></script>{% endif %}
<h3>Войти на сайт</h3>
...
<input type="hidden" name="redirect" value="{{ redirect }}" />
	...
	<input type="hidden" name="redirect" value="{{ redirect }}" />
	<input type="submit" value="{{ lang['login'] }}" name="Login" class="btn btn-primary btn-large"/><div class="clear10"></div>
	<ul class="meta">

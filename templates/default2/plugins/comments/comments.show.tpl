<div id="comment_{id}" class="comment">
	...
	<div class="data">
		<div class="info">
			<div class="title author">[profile]<a href="{profile_link}" target="_blank" title="{l_profile}">[/profile]{author}[profile]</a>[/profile]</div>
		...
		<div class="text">
			...
			[answer]<br /> -------------------------- <div><i>{l_answer}</i> <b>{name}</b><br />{answer}</div>[/answer]

...
<div class="bb">
	<table border="0" width="100%" cellpadding="0" cellspacing="0">
		[not-logged]
		<tr>
			<td style="color: #696969;">{l_name} <small>{l_necessary}</small></td>
			<td><input class="input" type="text"name="name" value="{savedname}" /></td>
		</tr>
		<tr>
			<td style="color: #696969;">{l_password} <small>{l_ifreg}</small></td>
			<td><input class="input" type="password" name="password" value="" /></td>
		</tr>
		<tr>
			<td style="color: #696969;">{l_email} <small>{l_necessary}</small></td>

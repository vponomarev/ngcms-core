[found]
<div class="alert alert-success">{l_search.found}: <b>{count}</b></div>[/found]
[notfound]
<div class="alert alert-info">{l_search.notfound}</div>[/notfound]
[error]
<div class="alert alert-error"><b>{l_search.error}</b></div>[/error]

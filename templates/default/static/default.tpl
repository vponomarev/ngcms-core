	...
	<tr>
		...
		<table border="0" width="100%" id="table2" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td background="{tpl_url}/images/2z_41.gif" width="100%">&nbsp;<b><font color="#FFFFFF">{title}</font></b> [edit-static]{l_editstatic}[/edit-static] [del-static]{l_delstatic}[/del-static]</td>
				<td>
	...
	<tr>
		...
		<table border="0" width="100%" id="table4" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td bgcolor="#FFFFFF"><br />{content}<br /></td>

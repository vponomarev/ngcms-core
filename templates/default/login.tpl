	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td style="background-image:url('{tpl_url}/images/2z_41.gif');" width="100%">&nbsp;<img border="0" src="{tpl_url}/images/bib.gif" />&nbsp;<b><font color="#FFFFFF">{l_login.title}</font></b></td>
	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				[need.activate]<tr><td colspan="2" align="center" style="background-color: red; color: white; font-weight: bold;">{l_login.need.activate}</td></tr>[/need.activate]

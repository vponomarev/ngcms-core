...
<table id="calendar" align="center" class="table">
	<tr>
		<td colspan="7" class="month"><a href="{{ prevMonth.link }}" onclick="ng_calendar_walk({{ currentEntry.month }}, {{ currentEntry.year }}, 'prev'); return false;">&laquo;</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ currentMonth.link }}">{{ currentMonth.name }} {{ currentEntry.year }}</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ nextMonth.link }}" onclick="ng_calendar_walk({{ currentEntry.month }}, {{ currentEntry.year }}, 'next'); return false;">&raquo;</a></td>
	</tr>
	<tr>

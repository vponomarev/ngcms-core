		...
		<header>
			...
			<div id="logo">
				<div class="in960">
					...
					<!-- /Менюшка-->
					<div class="k240">
						<a href="#userpanel" id="nolink" class="popup tooltip" rel="width:auto; height:auto;" title="{% if (global.flags.isLogged) %}Личный кабинет{% else %}Авторизация{% endif %}"><div class="user_btn"></div></a>
			...
			<div id="top">
				...
				<div class="home_banner">
					<div class="pad_banner">
						<h1>h1 заголовок выводится только на главной странице</h1>
						<p class="big">В этом блоке можно разместить нужную вам информацию или не использовать. Выбор за вами!</p>
						<p>Изменить это заголовок вы можите в main.tpl</p>
					</div>
				</div> 
				{% endif %}
				<!--/Шапка на главной-->
						...
						<div class="pad_left_col">
							...
							<div class="green_b">
								...
								<ul class="cat_b">
									<li><a href="{{ home }}">Главная</a></li>
									{{ categories }}
									{% if pluginIsActive('voting') %}<li {% if isHandler('voting') %}class="active"{% endif %}><a href="/plugin/voting/">Опросы</a></li>{% endif %}
									{% if pluginIsActive('sitemap') %}<li {% if isHandler('sitemap') %}class="active"{% endif %}><a href="/plugin/sitemap/">Карта сайта</a></li>{% endif %}
								</ul>
							</div>
							<div class="clear20"></div>
							<!--/Category-->
							...
							<div class="white_b">
								<!-- TABS START -->
								<ul class="tabs fixed">
									{% if pluginIsActive('calendar') %}<li><a href="#tab1">Календарь</a></li>{% endif %}
									{% if pluginIsActive('archive') %}<li><a href="#tab2">Архив</a></li>{% endif %}
									{% if pluginIsActive('voting') %}<li><a href="#tab3">Голосование</a></li>{% endif %}
								</ul>
								<div class="clear"></div>
							...
							<div class="white_b">
								<ul class="tabs fixed">
									{% if pluginIsActive('lastcomments') %}<li><a href="#tab4">Последние комментарии</a></li>{% endif %}
									{% if pluginIsActive('jchat') %}<li><a href="#tab5">Чатик</a></li>{% endif %}
								</ul>
								<div class="clear"></div>
		...
		<footer>
			<div id="ftr">
				<div class="in960">
					...
					<div class="pad20_f">
						<p>Эвтектика, по которому один блок опускается относительно другого, интенсивно прекращает цокольный генезис, и в то же время устанавливается достаточно приподнятый над уровнем моря коренной цоколь.</p>
					</div>
				</div>
				<div class="clear"></div>
				<div class="k320">&nbsp;</div>
				...
				<div class="k320">
					<div class="pad20_f">
						<p class="f12">SQL запросов: <b>{{ queries }}</b> | Генерация страницы: <b>{{ exectime }}</b> сек | <b>{{ memPeakUsage }}</b> Mb&nbsp;</p>
					</div>
				</div>
				<!--/Всякая нужная и ненужная хрень-->
				<!--Ссылки не убирать!!!!-->
				<div class="k320"> 
					<a href="http://rocketvip.ru" target="_blank"><img src="{{ tpl_url }}/images/rocketvip.png" class="right_s" alt="Создание, разработка и изготовление сайтов" /><font class="graphic">Создание, разработка и изготовление сайтов</font></a>
					&nbsp;
					<a href="http://ngcms.ru" target="_blank"><img src="{{ tpl_url }}/images/ngcms.png" class="right_s" alt="NGCMS - бесплатная система управления сайтом" /><font class="graphic">NGCMS - бесплатная система управления сайтом</font></a>
				</div>
				<!--/Ссылки не убирать!!!!-->
				<div class="clear20"></div>
			</div>

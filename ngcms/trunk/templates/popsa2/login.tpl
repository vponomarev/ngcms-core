...
<div class="full">
	...
	<div class="telo">
		[error]<div class="msge">{l_login.error}</div>[/error]
		[banned]<div class="msge">{l_login.banned}</div>[/banned]
		[need.activate]<div class="msgi">{l_login.need.activate}</div>[/need.activate]

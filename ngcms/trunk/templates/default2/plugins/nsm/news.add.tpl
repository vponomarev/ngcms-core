		...
		<p>
			...
			<table border="0" width="100%">
				...
				<tr>
					...
					<td width="70%"><input tabindex="2" type="text" name="content_delimiter" style="width: 98%;" class="input" value=""/></td>
				</tr>
				{% endif %}
				<tr>
					<td colspan="2">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td width="100%" valign="top">
						{% if flags['can_publish'] %}<button class="btn" type="submit" onclick="return approveMode(1);"><span>Добавить материал</span></button>{% else %} &nbsp; {% endif %}
						<button class="btn" type="submit" onclick="return approveMode(0);"><span>Отправить на модерацию</span></button>
						<button class="btn" type="submit" onclick="return approveMode(-1);"><span>Сохранить черновик</span></button>

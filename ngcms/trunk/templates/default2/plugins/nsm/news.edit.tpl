		...
		<p>
			<table border="0" width="100%">
				...
				<tr>
					...
					<td width="70%"><input type="text" name="alt_name" class="input" value="{{ alt_name }}" {% if flags['altname.disabled'] %}disabled="disabled" {% endif %} /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="70%"><input tabindex="2" type="text" name="content_delimiter" value="{{ content.delimiter }}" style="width: 98%;" class="input" value=""/></td>
				</tr>
				{% endif %}
				<tr>
					<td colspan="2">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr align="center">
					<td width="100%" valign="top">
						...
						<button class="btn" type="submit" onclick="return approveMode(-1);"><span>Отправить</span></button>{% endif %}
						<button class="btn" type="button" onClick="preview()"><span>Просмотр</span></button>
						{% if flags.deleteable %}<button class="btn" type="button" onClick="confirmit('{{ deleteURL }}', '{{ lang.editnews['sure_del'] }}')"><span>Удалить</span></button>{% endif %}
					</td>
				</tr>
			</table>
		</p>

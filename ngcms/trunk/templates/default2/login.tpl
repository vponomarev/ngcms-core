	...
	<div class="post-text">
		<p>
			<table border="0" width="100%">
				[error]
				<tr>
					<td colspan="2" align="center" style="background-color: red; color: white; font-weight: bold;">{l_login.error}</td>
				</tr>
				[/error]
				[banned]
				<tr>
					<td colspan="2" align="center" style="background-color: red; color: white; font-weight: bold;">{l_login.banned}</td>
				</tr>
				[/banned]
				[need.activate]
				<tr>
					<td colspan="2" align="center" style="background-color: red; color: white; font-weight: bold;">{l_login.need.activate}</td>
				</tr>
				[/need.activate]
				<tr>

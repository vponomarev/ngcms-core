	...
	<tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td bgcolor="#FFFFFF">[icon]<img src="{icon}" alt="" border="0" />[/icon][update]<br />{l_updated}{update}<br /><br />[/update]{short-story} [more][/more] {full-story}<div style="padding: 10px; text-align:center;">{pagination}</div><br />[isplugin finance][finance]<br />Стоимость доступа составляет: ${fin_price} [fin_on] <b>(оплачено)</b>[/fin_on][fin_off](не оплачено)[/fin_off][/finance][/isplugin]<br />{plugin_similar_tags}[isplugin rating]{plugin_rating}[/isplugin][isplugin tags][tags]<div align="right"><img src="{tpl_url}/images/tag.png" width="13" height="13" alt="Мета-теги" /> {tags}</div>[/tags][/isplugin]</td>

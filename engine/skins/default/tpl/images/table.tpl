		...
		<tr class="contHead">
			...
			<td>
				<input class="check" type="checkbox" name="master_box" title="{l_select_all}"
					onclick="javascript:check_uncheck_all(imagedelete)" />
			</td>
		</tr>
		{entries}
	...
	<tr>
		<td width="50%" valign="top" class="contentEntry1">
			<table border="0" cellspacing="0" cellpadding="0" class="content" align="center">
				<tr>
					<td class="contentHead"><img src="{skins_url}/images/nav.gif" hspace="8" alt="" />{l_upload_img}
					</td>
				</tr>
				<tr>
					<td>
						<form action="{php_self}?mod=images" method="post" enctype="multipart/form-data" name="sn">
							...
							<span id="showRemoveAddButtoms">
								<input type="button" class="button" value='{l_delone}'
									onClick="RemoveImages();return false;" />&nbsp;
								<input type="button" class="button" value='{l_onemore}'
									onClick="AddImages();return false;" /><br /><br />
							</span>
							...
							<div class="list">
								...
								<input type="checkbox" name="thumb" value="1" id="flagThumb" class='check'
									{thumb_mode}{thumb_checked} />
								<label for="flagThumb">{l_do_preview}</label><br />
								<input type="checkbox" name="shadow" value="1" id="flagShadow" class='check'
									{shadow_mode}{shadow_checked} />
								<label for="flagShadow">{l_do_shadow}</label><br />
								<input type="checkbox" name="stamp" value="1" id="flagStamp" class='check'
									{stamp_mode}{stamp_checked} />
				...
				<table border="0" cellspacing="0" cellpadding="0" class="content" align="center">
					...
					<tr>
						<td>
							...
							<br />{dirlist}&nbsp;
							<input type="button" class="button" value='{l_delone}'
								onClick="RemoveImages2();return false;" />&nbsp;
							<input type="button" class="button" value='{l_onemore}'
								onClick="AddImages2();return false;" /><br /><br />
							<script language="javascript" type="text/javascript">
								function AddImages2() {
							...
							<div class="list">
								...
								<input type="checkbox" name="shadow" value='shadow' id=shadow2 class='check'
									{shadow_mode}{shadow_checked} /><label for=shadow2>{l_do_shadow}</label><br />
								<input type="checkbox" name="stamp" value='stamp' id=stamp2 class='check'
									{stamp_mode}{stamp_checked} /><label for=stamp2>{l_do_wmimage}</label>
							</div>
						</td>
					</tr>
					<tr align="center">

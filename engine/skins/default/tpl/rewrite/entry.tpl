<tr class="contentEntry1" id="re.row.{id}">
	<td width="40px;"><a href="#" onclick="reMoveUp({id}); return false;"><img
				src="{{ skins_url }}/images/up.gif" /></a><a href="#" onclick="reMoveDown({id}); return false;"><img
	...
	<td class="contentEntry1" align="right" width="80px;">
		<input id="btn.{id}" type="button" class="navbutton" style="width: 30px;" value="Edit"
			onclick="reEditRow({id});" />
		<input id="btn.del.{id}" type="button" class="navbutton" style="width: 30px;" value="Del"
			onclick="reDeleteRow({id});" />
	</td>
</tr>

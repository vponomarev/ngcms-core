...
<tr align="left">
	...
	<td><input name="data[{{ entry.id }}][handler]" style="width: 90px;" value="{{ entry.handler }}"/></td>
	<td><input name="data[{{ entry.id }}][min]" style="width: 70px" value="{{ entry.min }}"/></td>
	<td><input name="data[{{ entry.id }}][hour]" style="width: 70px" value="{{ entry.hour }}"/></td>
	<td><input name="data[{{ entry.id }}][day]" style="width: 70px" value="{{ entry.day }}"/></td>
	<td><input name="data[{{ entry.id }}][month]" style="width: 70px" value="{{ entry.month }}"/></b></td>
	<td><input name="data[{{ entry.id }}][dow]" style="width: 70px" value="{{ entry.dow }}"/></b></td>
</tr>
{% endfor %}
</table>
</td></tr></table>

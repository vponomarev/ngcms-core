	...
	<tr>
		<td width=100% colspan="5" class="contentHead">
			<img src="{{ skins_url }}/images/nav.gif" hspace="8" /><a
				href="?mod=news">{{ lang.addnews['news_title'] }}</a>
					...
					<tr>
						<td class="contentNav" align="center">
							<input type="button" onmousedown="javascript:ChangeOption('maincontent')"
								value="{{ lang.addnews['bar.maincontent'] }}" class="navbutton" />
							<input type="button" onmousedown="javascript:ChangeOption('additional')"
								value="{{ lang.addnews['bar.additional'] }}" class="navbutton" />
							<input type="button" onmousedown="javascript:ChangeOption('attaches')"
								value="{{ lang.addnews['bar.attaches'] }}" class="navbutton" />
						</td>
					</tr>
					<tr>
						<td>
					...
					<table width="100%" cellspacing="1" cellpadding="2" border="0" id="attachFilelist">
						...
						<tbody>
							...
							<tr>
								<td colspan="3">&nbsp;</td>
								<td colspan="2">
									<input type="button" value="{{ lang.editnews['attach.more_rows'] }}" class="button"
			...
			<td id="rightBar" width="300" valign="top">
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="0">
					...
					<tr>
						...
						<td>
							<div class="list">
								<label><input type="checkbox" name="mainpage" value="1" class="check" id="mainpage"
										{% if (flags.mainpage) %}checked="checked"
										{% endif %}{% if flags['mainpage.disabled'] %}disabled {% endif %} />
									{{ lang.addnews['mainpage'] }}
								</label><br />
								<label><input type="checkbox" name="pinned" value="1" class="check" id="pinned"
										{% if (flags.pinned) %}checked="checked"
										{% endif %}{% if flags['pinned.disabled'] %}disabled {% endif %} />
									{{ lang.addnews['add_pinned'] }}
								</label><br />
								<label><input type="checkbox" name="catpinned" value="1" class="check" id="catpinned"
										{% if (flags.catpinned) %}checked="checked"
										{% endif %}{% if flags['catpinned.disabled'] %}disabled {% endif %} />
									{{ lang.addnews['add_catpinned'] }}
								</label><br />
								<label><input type="checkbox" name="favorite" value="1" class="check" id="favorite"
										{% if (flags.favorite) %}checked="checked"
										{% endif %}{% if flags['favorite.disabled'] %}disabled {% endif %} />
								...
								<label><input type="checkbox" name="flag_RAW" value="1" class="check" id="flag_RAW"
										{% if (flags['html.disabled']) %}disabled {% endif %}
										{% if (flags['raw']) %}checked="checked" {% endif %} />
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr align="center">
			<td width="30%" class="contentEditW" align="center" valign="top">
				...
				&nbsp; &nbsp;
				<input type="submit" value="{{ lang.addnews['save_draft'] }}" class="button"
					onclick="return approveMode(-1);" />
				&nbsp; &nbsp; &nbsp;
			</td>
			<td width="30%" class="contentEditW" align="center" valign="top">
				<input type="submit" value="{{ lang.addnews['send_moderation'] }}" class="button"
					onclick="return approveMode(0);" />
				&nbsp; &nbsp; &nbsp;
			</td>
			<td width="40%" class="contentEditW" align="center" valign="top">
				{% if flags['can_publish'] %}
				<input type="submit" value="{{ lang.addnews['publish'] }}" class="button"
					onclick="return approveMode(1);" />{% else %} &nbsp; {% endif %}
			</td>
		</tr>
	</table>

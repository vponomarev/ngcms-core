						...
						<tr>
							<td {% if (cat.flags.selected) %}style="background-color: #EEEEEE;" {% endif %}>
								...
								<div style="float: left;">
									<a href="?mod=news&category={{ cat.id }}">{{ cat.name }}</a>{% if (cat.posts>0) %} [
									{{ cat.posts }}]{% endif %}
								</div>
							</td>
						</tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" class="content" align="center">
					<thead>
						<tr align="left" class="contHead">
							...
							<td width="5%">&nbsp;</td>
							<td width="5%">
								<input class="check" type="checkbox" name="master_box"
									title="{{ lang.editnews['select_all'] }}"
					...
					<tbody>
						...
						<tr align="left">
							<td width="16" class="contentEntry1" cellspacing=0 cellpadding=0
								style="padding:0; margin:0;">{% if entry.flags.mainpage %}
								<img src="{{ skins_url }}/images/mainpage.png" border="0" width="16" height="16"
									title="Main" /> {% endif %}
							</td>
							<td class="contentEntry1">
								<a
									href="{{ php_self }}?mod=news&amp;action=edit&amp;id={{ entry.newsid }}">{{ entry.title }}</a><br />
							...
							<td class="contentEntry1">
								<input name="selected_news[]" value="{{ entry.newsid }}" class="check"
									type="checkbox" />
							</td>
						</tr>
						{% else %}
							...
							<td colspan="8" class="contentEdit" align="right" valign="top">
								<div style="text-align: left;">
									...
									<select name="subaction" style="font: 12px Verdana, Courier, Arial; width: 230px;">
										...
										<option value="mass_currdate">{{ lang.editnews['modify.mass.currdate'] }}
										</option>
										<option value="" style="background-color: #E0E0E0;" disabled="disabled">
											===================
										</option>

	...
	<tr>
		<td width=100% colspan="5" class="contentHead">
			<img src="{{ skins_url }}/images/nav.gif" hspace="8"><a
				href="?mod=configuration">{{ lang['configuration_title'] }}</a>
		</td>
	</tr>
</table>
		...
		<div id="userTabs-db">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input class="important" type="text" name="save_con[dbhost]" value="{{ config['dbhost'] }}"
							id="db_dbhost" size="40" />
					</td>
				</tr>
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input class="important" type="text" name='save_con[dbname]' value='{{ config['dbname'] }}'
							id="db_dbname" size="40" />
					</td>
				</tr>
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input class="important" type="text" name='save_con[dbuser]' value='{{ config['dbuser'] }}'
							id="db_dbuser" size="40" />
					</td>
				</tr>
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input class="password" type="password" name='save_con[dbpasswd]'
							value='{{ config['dbpasswd'] }}' id="db_dbpasswd" size="40" />
					</td>
				</tr>
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input class="important" type="text" name='save_con[prefix]' value='{{ config['prefix'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[auto_backup]', 'value' : config['auto_backup'] }) }}</td>
				</tr>
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input type="text" name='save_con[auto_backup_time]' value='{{ config['auto_backup_time'] }}'
							size="5" maxlength="5" />
					</td>
				</tr>
			</table>
		...
		<div id="userTabs-security">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectNY({'name' : 'save_con[x_ng_headers]', 'value' : config['x_ng_headers'] }) }}</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[syslog]', 'value' : config['syslog'] }) }}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[use_captcha]', 'value' : config['use_captcha'] }) }}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[use_cookies]', 'value' : config['use_cookies'] }) }}</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[use_sessions]', 'value' : config['use_sessions'] }) }}</td>
				</tr>
				<tr>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[debug]', 'value' : config['debug'] }) }}</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[debug_queries]', 'value' : config['debug_queries'] }) }}</td>
				</tr>
				<tr>
		...
		<div id="userTabs-system">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="home" type="text" name='save_con[home_url]' value='{{ config['home_url'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="home" type="text" name='save_con[admin_url]' value='{{ config['admin_url'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[home_title]' value="{{ config['home_title']|escape }}"
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="email" type="text" name='save_con[admin_mail]' value='{{ config['admin_mail'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectNY({'name' : 'save_con[lock]', 'value' : config['lock'] }) }}</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[lock_reason]' value='{{ config['lock_reason'] }}' size="40"
							maxlength="200" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[meta]', 'value' : config['meta'] }) }}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[use_gzip]', 'value' : config['use_gzip'] }) }}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[libcompat]', 'value' : config['libcompat'] }) }}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<select name="save_con[timezone]" id="timezone">
							...
							<option value="{{ zone }}" {% if (config['timezone'] == zone) %}selected="selected"
								{% endif %}>{{ zone }}</option>
							{% endfor %}
						</select>
					</td>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="mailfrom_name" type="text" id="mail_fromname" name='save_con[mailfrom_name]'
							value='{{ config['mailfrom_name'] }}' size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="mailfrom" type="text" id="mail_frommail" name='save_con[mailfrom]'
							value='{{ config['mailfrom'] }}' size="40" />
					</td>
				</tr>
				<tr>
				...
				<tr class="useSMTP">
					...
					<td class="contentEntry2" valign="middle">
						<input class="mailfrom" type="text" name="save_con[mail][smtp][host]" id="mail_smtp_host"
							value="{{ config['mail']['smtp']['host'] }}" size="40" />
					</td>
				</tr>
				<tr class="useSMTP">
					...
					<td class="contentEntry2" valign="middle">
						<input class="mailfrom" type="text" name="save_con[mail][smtp][port]" id="mail_smtp_port"
							size="40" value="{{ config['mail']['smtp']['port'] }}" />
					</td>
				</tr>
				<tr class="useSMTP">
				...
				<tr class="useSMTP">
					...
					<td class="contentEntry2" valign="middle">
						<input class="mailfrom" type="text" id="mail_smtp_login" name="save_con[mail][smtp][login]"
							value="{{ config['mail']['smtp']['login'] }}" size="40" />
					</td>
				</tr>
				<tr class="useSMTP">
					...
					<td class="contentEntry2" valign="middle">
						<input class="mailfrom" type="text" name="save_con[mail][smtp][pass]" id="mail_smtp_pass"
							value="{{ config['mail']['smtp']['pass'] }}" size="40" />
					</td>
				</tr>
				<tr>
					<td class="contentEntry1">
						<input type="button" value="{{ lang['btn_checkSMTP'] }}"
							onclick="ngCheckEmail(); return false;" />
					</td>
		...
		<div id="userTabs-news">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[newsNavigationsCount]'
							value='{{ config['newsNavigationsCount'] }}' size="6" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[newsNavigationsAdminCount]'
							value='{{ config['newsNavigationsAdminCount'] }}' size="6" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input type="text" name='save_con[timestamp_active]' value='{{ config['timestamp_active'] }}'
							size="20" /><br />
				...
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input type="text" name='save_con[timestamp_updated]' value='{{ config['timestamp_updated'] }}'
							size="20" /><br />
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[smilies]' value='{{ config['smilies'] }}'
							style="width: 400px" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectNY({'name' : 'save_con[extended_more]', 'value' : config['extended_more'] }) }}</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[use_smilies]', 'value' : config['use_smilies'] }) }}</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[use_bbcodes]', 'value' : config['use_bbcodes'] }) }}</td>
				</tr>
				<tr>
		...
		<div id="userTabs-users">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[user_aboutsize]' value='{{ config['user_aboutsize'] }}'
							style="width: 40px" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[use_avatars]', 'value' : config['use_avatars'] }) }}</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[avatars_url]'
							value='{{ config['avatars_url'] }}' size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[avatars_dir]'
							value='{{ config['avatars_dir'] }}' size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[avatar_wh]' value='{{ config['avatar_wh'] }}'
							style="width: 40px" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[avatar_max_size]' value='{{ config['avatar_max_size'] }}'
							style="width: 40px" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[use_photos]', 'value' : config['use_photos'] }) }}</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[photos_url]' value='{{ config['photos_url'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[photos_dir]' value='{{ config['photos_dir'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[photos_max_size]' value='{{ config['photos_max_size'] }}'
							style="width: 40px" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[photos_thumb_size_x]'
							value='{{ config['photos_thumb_size_x'] }}' style="width: 40px" />
						x
						<input type="text" name='save_con[photos_thumb_size_y]'
							value='{{ config['photos_thumb_size_y'] }}' style="width: 40px" />
					</td>
				</tr>
			</table>
		</div>
		...
		<div id="userTabs-imgfiles">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[files_url]' value='{{ config['files_url'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[files_dir]' value='{{ config['files_dir'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[attach_url]' value='{{ config['attach_url'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[attach_dir]' value='{{ config['attach_dir'] }}'
							size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="important" type="text" name='save_con[files_ext]'
							value='{{ config['files_ext'] }}' size="40" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[files_max_size]' value='{{ config['files_max_size'] }}'
							style="width: 40px" />
					</td>
				</tr>
			</table>
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[images_url]' value='{{ config['images_url'] }}'
							style="width: 400px" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="folder" type="text" name='save_con[images_dir]' value='{{ config['images_dir'] }}'
							style="width: 400px" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input class="important" type="text" name='save_con[images_ext]'
							value='{{ config['images_ext'] }}' style="width: 400px" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[images_max_size]' value='{{ config['images_max_size'] }}'
							size="6" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[images_max_x]' value='{{ config['images_max_x'] }}'
							size="6" />
						x
						<input type="text" name='save_con[images_max_y]' value='{{ config['images_max_y'] }}'
							size="6" />
					</td>
				</tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[thumb_size_x]' value='{{ config['thumb_size_x'] }}'
							size="6" />
						x
						<input type="text" name='save_con[thumb_size_y]' value='{{ config['thumb_size_y'] }}'
							size="6" />
					</td>
				</tr>
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[thumb_quality]' value='{{ config['thumb_quality'] }}'
							size="6" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						<input type="text" name='save_con[wm_image_transition]'
							value='{{ config['wm_image_transition'] }}' size="6" />
					</td>
				</tr>
		...
		<div id="userTabs-auth">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectYN({'name' : 'save_con[remember]', 'value' : config['remember'] }) }}</td>
				</tr>
				<tr>
		...
		<div id="userTabs-cache">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="contentEntry2" valign="middle">
						{{ mkSelectNY({'name' : 'save_con[use_memcached]', 'value' : config['use_memcached'] }) }}</td>
				</tr>
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input class="important" type="text" name='save_con[memcached_ip]'
							value='{{ config['memcached_ip'] }}' id="memcached_ip" size="40" />
					</td>
				</tr>
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input class="important" type="text" name='save_con[memcached_port]'
							value='{{ config['memcached_port'] }}' id="memcached_port" size="40" />
					</td>
				</tr>
				<tr>
					...
					<td width="50%" class="contentEntry2" valign="middle">
						<input class="important" type="text" name='save_con[memcached_prefix]'
							value='{{ config['memcached_prefix'] }}' id="memcached_prefix" size="40" />
					</td>
				</tr>
				<tr>
					<td width="50%" class="contentEntry1">&nbsp;</td>
					<td width="50%" class="contentEntry2">
						<input type="button" value="{{ lang['btn_checkMemcached'] }}"
							onclick="ngCheckMemcached(); return false;" />
					</td>
				</tr>
			</table>
		</div>

...
<form name="form" method="post" action="{php_self}?mod=editcomments">
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		<tr align="center">
			<td width="100%" class="contentNav" align="center" valign="top">
				<input type="button" onmousedown="javascript:ChangeOption('maincontent')" value="{l_maincontent}"
					class="navbutton" />
				<input type="button" onmousedown="javascript:ChangeOption('additional')" value="{l_additional}"
					class="navbutton" />
			</td>
		</tr>
	</table>
	...
	<table id="maincontent" border="0" cellspacing="0" cellpadding="0" class="content" align="center">
		<tr>
			<td width="100%" colspan="2" class="contentHead"><img src="{skins_url}/images/nav.gif"
					hspace="8" />{l_answer}
			</td>
		</tr>
		<tr>
	...
	<table id="additional" style="display: none;" border="0" cellspacing="0" cellpadding="0" class="content"
		align="center">
		<tr>
		...
		<tr align="center">
			<td width="100%" class="contentEdit">
				...
				<input type=button value="{l_delete}"
					onClick="confirmit('{php_self}?mod=editcomments&subaction=deletecomment&newsid={newsid}&comid={comid}&poster={author}', '{l_sure_del}')"
					class="button" tabindex="6">
				<input type="button" value="{l_block_ip}" onClick="document.location='{php_self}?mod=ipban&iplock={ip}'"
					class="button" />

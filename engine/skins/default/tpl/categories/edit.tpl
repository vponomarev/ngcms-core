	...
	<table class="content" border="0" cellspacing="0" cellpadding="0" align="center">
		<tr>
			<td width="100%" colspan="5" class="contentHead">
				<img src="{{ skins_url }}/images/nav.gif" hspace="8" alt="" /><a
		...
		<tr>
			...
			<td width="30%" class="contentEntry2">
				<input type="checkbox" id="cat_show" name="cat_show" value="1" class="check"
					{% if flags.showInMenu %}checked="checked" {% endif %} />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="30%" class="contentEntry2"><input value="{{ alt_url }}" type=text size="40" name="alt_url" />
			</td>
		</tr>
		<tr>
		...
		<tr align="center">
			<td width="100%" colspan="2" class="contentEdit">{% if flags.canModify %}
				...
				<input type="button" class="button" value="{{ lang['cancel'] }}"
					onclick="document.location='admin.php?mod=categories';" />

...
<a onclick="insertext('[url]','[/url]', {area})" title='{l_tags.link}'><img src="{skins_url}/tags/link.gif" hspace="5" vspace="5"></a>
...
<a onclick="insertext('[email]','[/email]', {area})" title='{l_tags.email}'><img src="{skins_url}/tags/email.gif" hspace="5" vspace="5"></a>
	<!--
...
<a onclick="insertext('[img]','[/img]', {area})" title='{l_tags.imagelink}'><img src="{skins_url}/tags/imagelink.gif" hspace="5" vspace="5"></a>
